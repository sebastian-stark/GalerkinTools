...
check()
{
	...
	assembly_helper.get_nonprimitive_scalar_functional_values(solution, solution_ref_sets, nonprimitive_scalar_functional_values_domain, nonprimitive_scalar_functional_values_interface);
	...
	map<const ScalarFunctional<spacedim, spacedim>*, double> nonprimitive_scalar_functional_values_domain_seq;
	map<const ScalarFunctional<spacedim-1, spacedim>*, double> nonprimitive_scalar_functional_values_interface_seq;
	assembly_helper_seq.get_nonprimitive_scalar_functional_values(solution_seq, solution_ref_sets_seq, nonprimitive_scalar_functional_values_domain_seq, nonprimitive_scalar_functional_values_interface_seq);

	double error = 0.0;
	auto scalar_functional_domain_seq_it = nonprimitive_scalar_functional_values_domain_seq.begin();
	for(const auto& scalar_functional : nonprimitive_scalar_functional_values_domain)
	{
		error += fabs(scalar_functional.second - scalar_functional_domain_seq_it->second);
		++scalar_functional_domain_seq_it;
	}
	auto scalar_functional_interface_seq_it = nonprimitive_scalar_functional_values_interface_seq.begin();
	for(const auto& scalar_functional : nonprimitive_scalar_functional_values_interface)
	{
		error += fabs(scalar_functional.second - scalar_functional_interface_seq_it->second);
		++scalar_functional_interface_seq_it;
	}
	error = error / ( nonprimitive_scalar_functional_values_domain.size() + nonprimitive_scalar_functional_values_interface.size() );
