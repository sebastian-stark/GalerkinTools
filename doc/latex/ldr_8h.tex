...
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{namespace_auxiliary_abe796c1529d11eed08fd05bca82f3002}{Auxiliary\+::compute\+\_\+ldr}} (\textbf{ Full\+Matrix}$<$ double $>$ \&\textbf{ C}, \textbf{ Vector}$<$ double $>$ \&D, \textbf{ std\+::vector}$<$ \textbf{ Vector}$<$ double $>$$>$ \&\textbf{ L}, \textbf{ std\+::vector}$<$ \textbf{ Vector}$<$ double $>$$>$ \&R)
\end{DoxyCompactItemize}
