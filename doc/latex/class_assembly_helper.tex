...
\item 
std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ unsigned int $>$ $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper_ab6df6b4da6a8877be35c13345426a411}{coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+local}}
\item 
std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ unsigned int $>$ $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper_a4d62f9d5fa67a3aff4a377641b70f883}{coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+locally\+\_\+eliminated}}
\item 
std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ unsigned int $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper_a81d6f5bd0af1c954c9d7ff4050663e31}{coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+not\+\_\+local}}
\item 
...
\item 
std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ bool $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper_a547c7d4ffd7379860f15095d494b1d68}{e\+\_\+omega\+\_\+local}}
\item 
std\+::vector$<$ std\+::vector$<$ std\+::vector$<$ bool $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper_ae0a15696126a39f90d97d0d5ba23096b}{e\+\_\+omega\+\_\+locally\+\_\+eliminated}}
\item 
...
{\footnotesize\ttfamily template$<$unsigned int spacedim$>$ \\
std\+::vector$<$std\+::vector$<$std\+::vector$<$std\+::vector$<$unsigned int$>$ $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper}{Assembly\+Helper}}$<$ spacedim $>$\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+local\hspace{0.3cm}{\ttfamily [private]}}

Essentially the same as \mbox{\hyperlink{class_assembly_helper_a1a26b40224e3f04e5168accc91486493}{Assembly\+Helper\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain}}. However, only dofs related to local independent fields (but not locally eliminated fields) are included. In addition, these dofs are sorted according to quadrature points. I.\+e., coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+local\mbox{[}{\ttfamily u}\mbox{]}\mbox{[}{\ttfamily v}\mbox{]}\mbox{[}{\ttfamily q}\mbox{]} contains all (cell related) local dof indices which couple for the {\ttfamily v-\/th} scalar functional on the domain portion with internal index {\ttfamily u} at the quadrature point {\ttfamily q}. \mbox{\Hypertarget{class_assembly_helper_a4d62f9d5fa67a3aff4a377641b70f883}\label{class_assembly_helper_a4d62f9d5fa67a3aff4a377641b70f883}} 
...
{\footnotesize\ttfamily template$<$unsigned int spacedim$>$ \\
std\+::vector$<$std\+::vector$<$std\+::vector$<$std\+::vector$<$unsigned int$>$ $>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper}{Assembly\+Helper}}$<$ spacedim $>$\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+locally\+\_\+eliminated\hspace{0.3cm}{\ttfamily [private]}}

Essentially the same as \mbox{\hyperlink{class_assembly_helper_a1a26b40224e3f04e5168accc91486493}{Assembly\+Helper\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain}}. However, only dofs related to locally eliminated independent fields are included. In addition, these dofs are sorted according to quadrature points. I.\+e., coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+locally\+\_\+eliminated\mbox{[}{\ttfamily u}\mbox{]}\mbox{[}{\ttfamily v}\mbox{]}\mbox{[}{\ttfamily q}\mbox{]} contains all (cell related) locally eliminated dof indices which couple for the {\ttfamily v-\/th} scalar functional on the domain portion with internal index {\ttfamily u} at the quadrature point {\ttfamily q}. \mbox{\Hypertarget{class_assembly_helper_a81d6f5bd0af1c954c9d7ff4050663e31}\label{class_assembly_helper_a81d6f5bd0af1c954c9d7ff4050663e31}} 
...
{\footnotesize\ttfamily template$<$unsigned int spacedim$>$ \\
std\+::vector$<$std\+::vector$<$std\+::vector$<$unsigned int$>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper}{Assembly\+Helper}}$<$ spacedim $>$\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain\+\_\+not\+\_\+local\hspace{0.3cm}{\ttfamily [private]}}

Essentially the same as \mbox{\hyperlink{class_assembly_helper_a1a26b40224e3f04e5168accc91486493}{Assembly\+Helper\+::coupled\+\_\+dof\+\_\+indices\+\_\+scalar\+\_\+functionals\+\_\+domain}}. However, only dofs related to independent field which are neither local nor locally eliminated are included \mbox{\Hypertarget{class_assembly_helper_ab346e146cf91fb7a0688076551b37355}\label{class_assembly_helper_ab346e146cf91fb7a0688076551b37355}} 
...
The \mbox{\hyperlink{class_do_f_handler_system}{Do\+F\+Handler\+System}} \mbox{\Hypertarget{class_assembly_helper_a547c7d4ffd7379860f15095d494b1d68}\label{class_assembly_helper_a547c7d4ffd7379860f15095d494b1d68}} 
\index{AssemblyHelper$<$ spacedim $>$@{AssemblyHelper$<$ spacedim $>$}!e\_omega\_local@{e\_omega\_local}}
\index{e\_omega\_local@{e\_omega\_local}!AssemblyHelper$<$ spacedim $>$@{AssemblyHelper$<$ spacedim $>$}}
\doxysubsubsection{\texorpdfstring{e\_omega\_local}{e\_omega\_local}}
{\footnotesize\ttfamily template$<$unsigned int spacedim$>$ \\
std\+::vector$<$std\+::vector$<$std\+::vector$<$bool$>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper}{Assembly\+Helper}}$<$ spacedim $>$\+::e\+\_\+omega\+\_\+local\hspace{0.3cm}{\ttfamily [private]}}

This member contains information about whether the dependent field is local.

\mbox{\hyperlink{class_assembly_helper_a547c7d4ffd7379860f15095d494b1d68}{Assembly\+Helper\+::e\+\_\+omega\+\_\+local}}\mbox{[}{\ttfamily u}\mbox{]}\mbox{[}{\ttfamily v}\mbox{]}\mbox{[}{\ttfamily k}\mbox{]} contains whether the {\ttfamily k-\/th} dependent field of the {\ttfamily v-\/th} scalar functional on the domain portion with internal index {\ttfamily u} is local. \mbox{\Hypertarget{class_assembly_helper_ae0a15696126a39f90d97d0d5ba23096b}\label{class_assembly_helper_ae0a15696126a39f90d97d0d5ba23096b}} 
\index{AssemblyHelper$<$ spacedim $>$@{AssemblyHelper$<$ spacedim $>$}!e\_omega\_locally\_eliminated@{e\_omega\_locally\_eliminated}}
\index{e\_omega\_locally\_eliminated@{e\_omega\_locally\_eliminated}!AssemblyHelper$<$ spacedim $>$@{AssemblyHelper$<$ spacedim $>$}}
\doxysubsubsection{\texorpdfstring{e\_omega\_locally\_eliminated}{e\_omega\_locally\_eliminated}}
{\footnotesize\ttfamily template$<$unsigned int spacedim$>$ \\
std\+::vector$<$std\+::vector$<$std\+::vector$<$bool$>$ $>$ $>$ \mbox{\hyperlink{class_assembly_helper}{Assembly\+Helper}}$<$ spacedim $>$\+::e\+\_\+omega\+\_\+locally\+\_\+eliminated\hspace{0.3cm}{\ttfamily [private]}}

This member contains information about whether the dependent field is locally eliminated.

\mbox{\hyperlink{class_assembly_helper_ae0a15696126a39f90d97d0d5ba23096b}{Assembly\+Helper\+::e\+\_\+omega\+\_\+locally\+\_\+eliminated}}\mbox{[}{\ttfamily u}\mbox{]}\mbox{[}{\ttfamily v}\mbox{]}\mbox{[}{\ttfamily k}\mbox{]} contains whether the {\ttfamily k-\/th} dependent field of the {\ttfamily v-\/th} scalar functional on the domain portion with internal index {\ttfamily u} is locally eliminated. \mbox{\Hypertarget{class_assembly_helper_a16aa77ea3867740a280fd50f5578adfc}\label{class_assembly_helper_a16aa77ea3867740a280fd50f5578adfc}} 
