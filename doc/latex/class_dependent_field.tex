...
\item 
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ dim, spacedim $>$ $>$ \& \mbox{\hyperlink{class_dependent_field_a4011707cbf799347a63e92d196d0e5e1}{get\+\_\+terms\+\_\+interface}} () const
\item 
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ dim+1, spacedim $>$ $>$ \& \mbox{\hyperlink{class_dependent_field_a61f0205166754053e5f7beaa8edf7784}{get\+\_\+terms\+\_\+neighbor}} (const \mbox{\hyperlink{triangulation__system_8h_a44f3c00e36c1d6e3c389ae693c09b435}{Interface\+Side}} side) const
\item 
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ 0, spacedim $>$ $>$ \& \mbox{\hyperlink{class_dependent_field_aab79e0a11ed661b0399d89d646ac2043}{get\+\_\+terms\+\_\+independent\+\_\+scalars}} () const
\item 
...
\begin{DoxyCompactItemize}
\item 
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ dim, spacedim $>$ $>$ \mbox{\hyperlink{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}{terms\+\_\+interface}}
\item 
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ dim+1, spacedim $>$ $>$ \mbox{\hyperlink{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}{terms\+\_\+neighbor\+\_\+plus}}
\item 
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ dim+1, spacedim $>$ $>$ \mbox{\hyperlink{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}{terms\+\_\+neighbor\+\_\+minus}}
\item 
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$ 0, spacedim $>$ $>$ \mbox{\hyperlink{class_dependent_field_aa1ba265eae76489d22d3eecd595931c5}{terms\+\_\+independent\+\_\+scalars}}
\item 
...
Add a term $c^\Sigma_{\nu\iota} C_\iota$ to \mbox{\hyperlink{class_dependent_field_aa1ba265eae76489d22d3eecd595931c5}{Dependent\+Field\+::terms\+\_\+independent\+\_\+scalars}} ({\ttfamily coefficient} is $c^\Sigma_{\nu\iota}$, {\ttfamily independent\+\_\+field} is $C_\iota$).
...
Add a term $a^+_{\nu\epsilon} (u^\Omega_\epsilon)^+$ or $a^-_{\nu\epsilon} (u^\Omega_\epsilon)^-$ to \mbox{\hyperlink{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+plus}} or \mbox{\hyperlink{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+minus}}, respectively ({\ttfamily coefficient} is $a^+_{\nu\epsilon}$ or $a^-_{\nu\epsilon}$ depending on {\ttfamily side}, {\ttfamily independent\+\_\+field} and {\ttfamily component} describe $u^\Omega_\epsilon$, {\ttfamily side} specifies the side of the interface on which the independent field is evaluated).
...
Add a term to \mbox{\hyperlink{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+plus}} or \mbox{\hyperlink{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+minus}}.
...
Add a term $b^\Sigma_{\nu \eta i} \dfrac{\partial u^\Sigma_\eta}{\partial x_i}$ to \mbox{\hyperlink{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}{Dependent\+Field\+::terms\+\_\+interface}} ({\ttfamily coefficient} is $b^\Sigma_{\nu \eta i}$, {\ttfamily independent\+\_\+field} and {\ttfamily component} describe $u^\Sigma_\eta$, {\ttfamily derivative} is $i$).
...
Add a term to \mbox{\hyperlink{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}{Dependent\+Field\+::terms\+\_\+interface}}.
...
This methods returns \mbox{\hyperlink{class_dependent_field_aacdabff2601b1f0efcdce7a4413b47bc}{Dependent\+Field\+::is\+\_\+local}} \mbox{\Hypertarget{class_dependent_field_aab79e0a11ed661b0399d89d646ac2043}\label{class_dependent_field_aab79e0a11ed661b0399d89d646ac2043}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$0, spacedim$>$ $>$\& \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::get\+\_\+terms\+\_\+independent\+\_\+scalars (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const}

\begin{DoxyReturn}{Returns}
A const reference to \mbox{\hyperlink{class_dependent_field_aa1ba265eae76489d22d3eecd595931c5}{Dependent\+Field\+::terms\+\_\+independent\+\_\+scalars}} 
\end{DoxyReturn}
\mbox{\Hypertarget{class_dependent_field_a4011707cbf799347a63e92d196d0e5e1}\label{class_dependent_field_a4011707cbf799347a63e92d196d0e5e1}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$dim, spacedim$>$ $>$\& \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::get\+\_\+terms\+\_\+interface (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const}

\begin{DoxyReturn}{Returns}
A const reference to \mbox{\hyperlink{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}{Dependent\+Field\+::terms\+\_\+interface}} 
\end{DoxyReturn}
\mbox{\Hypertarget{class_dependent_field_a61f0205166754053e5f7beaa8edf7784}\label{class_dependent_field_a61f0205166754053e5f7beaa8edf7784}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
const std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$dim+1, spacedim$>$ $>$\& \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::get\+\_\+terms\+\_\+neighbor (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{triangulation__system_8h_a44f3c00e36c1d6e3c389ae693c09b435}{Interface\+Side}}}]{side }\end{DoxyParamCaption}) const}


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em side} & Determines whether \mbox{\hyperlink{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+minus}} or \mbox{\hyperlink{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+plus}} is returned\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A const reference to \mbox{\hyperlink{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+minus}} or \mbox{\hyperlink{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}{Dependent\+Field\+::terms\+\_\+neighbor\+\_\+plus}} depending on {\ttfamily side} 
\end{DoxyReturn}
...
The name of the dependent field, which is used to identify it in output, etc. \mbox{\Hypertarget{class_dependent_field_aa1ba265eae76489d22d3eecd595931c5}\label{class_dependent_field_aa1ba265eae76489d22d3eecd595931c5}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$0, spacedim$>$ $>$ \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::terms\+\_\+independent\+\_\+scalars\hspace{0.3cm}{\ttfamily [private]}}

This set contains all summands making up the term $\sum_{\iota \in I}c^\Sigma_{\nu\iota} C_\iota$ of the dependent field. \mbox{\Hypertarget{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}\label{class_dependent_field_aa6326d64fd7828c935946136ec5ec122}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$dim, spacedim$>$ $>$ \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::terms\+\_\+interface\hspace{0.3cm}{\ttfamily [private]}}

This set contains all summands making up the term $\sum_{\eta \in H} \left[ a^\Sigma_{\nu\eta} u^\Sigma_\eta + b^\Sigma_{\nu\eta i} \dfrac{\partial u^\Sigma_\eta}{\partial x_i} \right]$ of the dependent field. \mbox{\Hypertarget{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}\label{class_dependent_field_a9ac1d390137d52ef6c58b230d540ce38}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$dim+1, spacedim$>$ $>$ \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::terms\+\_\+neighbor\+\_\+minus\hspace{0.3cm}{\ttfamily [private]}}

This set contains all summands making up the term $\sum_{\epsilon \in E} \left[ a^-_{\nu\epsilon} (u^\Omega_\epsilon)^- + b^-_{\nu\epsilon i} \left(\dfrac{\partial u^\Omega_\epsilon}{\partial x_i}\right)^- \right]$ of the dependent field. \mbox{\Hypertarget{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}\label{class_dependent_field_a05ba04a9f0f50fd881055f3abf46c9f5}} 
...
{\footnotesize\ttfamily template$<$unsigned int dim, unsigned int spacedim$>$ \\
std\+::set$<$ \mbox{\hyperlink{class_dependent_field_term}{Dependent\+Field\+Term}}$<$dim+1, spacedim$>$ $>$ \mbox{\hyperlink{class_dependent_field}{Dependent\+Field}}$<$ dim, spacedim $>$\+::terms\+\_\+neighbor\+\_\+plus\hspace{0.3cm}{\ttfamily [private]}}
