...
\begin{DoxyItemize}
\item local independent fields must have a 1 to 1 correspondence to a dependent field in that the dependent field equals the local independent field (this could be relaxed; however this would substantially complicate the implementation)
